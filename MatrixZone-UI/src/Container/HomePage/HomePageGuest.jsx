...
function FirstSection() {
    ...
    return (
        <div className="FirstSectionContainer">
            ...
            <div
                className={`LogOutSectionGuest ${
                    isGIFVisible ? "ShowGIF" : ""
                }`}
            >
                <div
                ...
                <div
                    className="LogOutContainer2Guest"
            ...
            <section className="HomeFirstSectionCarousel">
                ...
                >
                    <CaretLeftFilled
                        style={{ color: "#03A062", fontSize: 40 }}
                    />
                </button>
                <button
