    ...
    return (
        <div className="FirstSectionContainer">
            ...
            <div className={`LogOutSectionGuest ${isGIFVisible ? "ShowGIF" : ""}`}>
                <div className="LogOutContainer1" style={{ display: isVisible1 ? "block" : "none" }} onClick={() => displayUser2()}>
                ...
                <h2 className="Welcome" style={{ display: isVisibleW ? "block" : "none" }}>WELCOME GUEST</h2>
            </div>
            <section className="HomeFirstSectionCarousel">
                            ...
                            <div className="CarouselSlide1" style={contentStyle}>
                                <div className="CarouselItem1">
                                    <div className="NameAndJob">
                                        ...
                                        <h2 className="JobTitle">{info.LinkedIn.jobTitle}</h2>
                                    </div>
                ...
                <button className="CarouselButtonLeft" onClick={() => { ref.current.prev() }}><CaretLeftFilled style={{ color: "#03A062", fontSize: 40 }} /></button>
                <button className="CarouselButtonRight" onClick={() => { ref.current.next() }}><CaretRightFilled style={{ color: "#03A062", fontSize: 40 }} /></button>
            </section>
            <section className="HomeFirstSection1">
                ...
                <div className="GoToMyProfile">
                    ...
                    <div className="ProfileTextBox">
                        ...
                        <button className="GoToProfile" onClick={() => navigate(info.routes.profilePageGuest)}>Profile</button>
                    </div>
            ...
            <section className="HomeFirstSection2">
                ...
                <div className="GoToMyProjects">
                    ...
                    <div className="ProjectsTextBox">
                        ...
                        <button className="GoToProjects" onClick={() => navigate(info.routes.projectsPageGuest)}>Projects</button>
                    </div>
            ...
            <section className="HomeFirstSection3">
                ...
                <div className="GoToMyVideos">
                    ...
                    <div className="VideosTextBox">
                        ...
                        <p>{info.GitHub.user}</p>
                        <p>{info.GitHub.name}</p>
                        <button className="GoToVideos" onClick={() => navigate(info.routes.videosPageGuest)}>Videos</button>
                    </div>
