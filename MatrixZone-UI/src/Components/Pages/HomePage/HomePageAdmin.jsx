    ...
    return (
        <div className="FirstSectionContainer">
            ...
            <div className={`LogOutSectionAdmin ${isGIFVisible ? "ShowGIF" : ""}`}>
                ...
                <h2 className="Welcome" style={{ display: isVisibleY ? "block" : "none" }}>WELCOME ADMIN</h2>
            </div>
            ...
            <section className="HomeFirstSection1">
                ...
                <div className="GoToMyProfile">
                    ...
                    <div className="ProfileTextBox">
                        ...
                        <button className="GoToProfile" onClick={() => navigate(info.routes.profilePageAdmin)}>Profile</button>
                    </div>
            ...
            <section className="HomeFirstSection2">
                ...
                <div className="GoToMyProjects">
                    ...
                    <div className="ProjectsTextBox">
                        ...
                        <button className="GoToProjects" onClick={() => navigate(info.routes.projectsPageAdmin)}>Projects</button>
                    </div>
            ...
            <section className="HomeFirstSection3">
                ...
                <div className="GoToMyVideos">
                    ...
                    <div className="VideosTextBox">
                        ...
                        <p>{info.GitHub.user}</p>
                        <p>{info.GitHub.name}</p>
                        <button className="GoToVideos" onClick={() => navigate(info.routes.videosPageAdmin)}>Videos</button>
                    </div>
