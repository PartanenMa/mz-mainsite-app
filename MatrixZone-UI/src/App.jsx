...
import ExperiencePageGuest from "./Container/ExperiencePage/ExperiencePageGuest.jsx";
import ExperiencePageAdmin from "./Container/ExperiencePage/ExperiencePageAdmin.jsx";
import ContactPageGuest from "./Container/ContactPage/ContactPageGuest.jsx";
import ContactPageAdmin from "./Container/ContactPage/ContactPageAdmin.jsx";
        ...
        <>
            ...
            )}
            {
                <div className="AppContainer">
                    <Routes>
                        <Route
                            path={info.routes.frontPage}
                            element={<FrontPage />}
                        />
                        <Route
                            path={info.routes.loginPage}
                            element={<LoginPage />}
                        />
                        <Route
                            path={info.routes.aboutPage}
                            element={<AboutPage />}
                        />
                        <Route
                            path={info.routes.homePageGuest}
                            element={<HomePageGuest />}
                        />
                        <Route
                            path={info.routes.homePageAdmin}
                            element={<HomePageAdmin />}
                        />
                        <Route
                            path={info.routes.profilePageGuest}
                            element={<ProfilePageGuest />}
                        />
                        <Route
                            path={info.routes.profilePageAdmin}
                            element={<ProfilePageAdmin />}
                        />
                        <Route
                            path={info.routes.iTInfraPageGuest}
                            element={<ITInfraPageGuest />}
                        />
                        <Route
                            path={info.routes.iTInfraPageAdmin}
                            element={<ITInfraPageAdmin />}
                        />
                        <Route
                            path={info.routes.programmingPageGuest}
                            element={<ProgrammingPageGuest />}
                        />
                        <Route
                            path={info.routes.programmingPageAdmin}
                            element={<ProgrammingPageAdmin />}
                        />
                        <Route
                            path={info.routes.roboticsPageGuest}
                            element={<RoboticsPageGuest />}
                        />
                        <Route
                            path={info.routes.roboticsPageAdmin}
                            element={<RoboticsPageAdmin />}
                        />
                        <Route
                            path={info.routes.gamingPageGuest}
                            element={<GamingPageGuest />}
                        />
                        <Route
                            path={info.routes.gamingPageAdmin}
                            element={<GamingPageAdmin />}
                        />
                        <Route
                            path={info.routes.webDevPageGuest}
                            element={<WebDevPageGuest />}
                        />
                        <Route
                            path={info.routes.webDevPageAdmin}
                            element={<WebDevPageAdmin />}
                        />
                        <Route
                            path={info.routes.campingPageGuest}
                            element={<CampingPageGuest />}
                        />
                        <Route
                            path={info.routes.campingPageAdmin}
                            element={<CampingPageAdmin />}
                        />
                        <Route
                            path={info.routes.projectsPageGuest}
                            element={<ProjectsPageGuest />}
                        />
                        <Route
                            path={info.routes.projectsPageAdmin}
                            element={<ProjectsPageAdmin />}
                        />
                        <Route
                            path={info.routes.videosPageGuest}
                            element={<VideosPageGuest />}
                        />
                        <Route
                            path={info.routes.videosPageAdmin}
                            element={<VideosPageAdmin />}
                        />
                        <Route
                            path={info.routes.experiencePageGuest}
                            element={<ExperiencePageGuest />}
                        />
                        <Route
                            path={info.routes.experiencePageAdmin}
                            element={<ExperiencePageAdmin />}
                        />
                        <Route
                            path={info.routes.contactPageGuest}
                            element={<ContactPageGuest />}
                        />
                        <Route
                            path={info.routes.contactPageAdmin}
