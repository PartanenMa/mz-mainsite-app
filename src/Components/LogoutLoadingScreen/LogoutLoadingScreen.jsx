...
function LogoutLoadingScreen() {
    ...
    return (
        <>
            ...
            {windowWidth < 1280 && (
                <div className="logoutLoadingScreenContainerMobile">
                    <LoadingLogoMobile />
...
function LoadingLogo() {
    return (
        <div className="logoutLoadingLogoContainer">
            <div className="logoutMatrixLogo" />
        </div>
    );
}
...
function LoadingLogoMobile() {
    return (
        <div className="logoutLoadingLogoContainerMobile">
            <div className="logoutMatrixLogoMobile" />
        </div>
    );
}
...
function LoadingTitleContainerMobile() {
    return (
        <svg className="logoutLoadingTitleContainerMobile" viewBox="0 0 74 14">
            <g id="page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id="artboard" transform="translate(-9.000000, -7.000000)">
                    <g id="group-2" transform="translate(9.000000, 7.000000)">
                        <rect id="rectangle" x="0" y="0" width="74" height="14" rx="4"></rect>
...
function LoadingSectionMobile() {
    return (
        <div className="logoutLoadingContainerMobile">
            <h2>LOADING...</h2>
            <div className="logoutLogo_reactLMobile" />
        </div>
    );
}
