...
export const info = {
    ...
    routes: {
        ...
        loginPage: deployToGitHubPages ? "/mz-mainsite-app/login" : "/login",
        homePage: deployToGitHubPages ? "/mz-mainsite-app/home" : "/home",
        homePageAdmin: deployToGitHubPages ? "/mz-mainsite-app/admin/home" : "/admin/home",
        profilePage: deployToGitHubPages ? "/mz-mainsite-app/profile" : "/profile",
        profilePageAdmin: deployToGitHubPages ? "/mz-mainsite-app/admin/profile" : "/admin/profile",
        projectsPage: deployToGitHubPages ? "/mz-mainsite-app/projects" : "/projects",
        projectsPageAdmin: deployToGitHubPages ? "/mz-mainsite-app/admin/projects" : "/admin/projects",
        projectPage: deployToGitHubPages ? "/mz-mainsite-app/projects/view/:id" : "/projects/view/:id",
        projectPageAdmin: deployToGitHubPages ? "/mz-mainsite-app/admin/projects/view/:id" : "/admin/projects/view/:id",
        videosPage: deployToGitHubPages ? "/mz-mainsite-app/videos" : "/videos",
        videosPageAdmin: deployToGitHubPages ? "/mz-mainsite-app/admin/videos" : "/admin/videos",
        videoPage: deployToGitHubPages ? "/mz-mainsite-app/videos/watch/:id" : "/videos/watch/:id",
        videoPageAdmin: deployToGitHubPages ? "/mz-mainsite-app/admin/videos/watch/:id" : "/admin/videos/watch/:id",
        goalsPage: deployToGitHubPages ? "/mz-mainsite-app/goals" : "/goals",
