        ...
        <div className="firstSectionContainer">
                        ...
                        {info.api.enabled ? (
                            (professionData?.professionStatus && !loadingProfessionData) || (jobData?.jobStatus && !loadingJobData) ? (
                                <motion.p
                                    ...
                                    key="professionorjobdatasuccessA"
            ...
            <section className="homeFirstSection2">
                ...
                <div className="goToMyProjects">
                    ...
                    <div className="projectsTextBox" style={{ backgroundColor: info.projects.secondaryColor, border: `1px solid ${info.profile.color}` }}>
                        <AnimatePresence>
                            <motion.a
                                title={"My " + info.projects.siteName}
                                style={{ "--projects-color": info.projects.color }}
                    ...
                    <div className="profileTextBoxMobile" style={{ backgroundColor: info.profile.secondaryColor, border: `1px solid ${info.profile.color}` }}>
                        ...
                        {info.api.enabled ? (
                            (professionData?.professionStatus && !loadingProfessionData) || (jobData?.jobStatus && !loadingJobData) ? (
                                <motion.p
                                    style={{ color: info.profile.color }}
                                    key="professionorjobdatasuccessmobileA"
                                    transition={{ delay: 0.5 }}
                                    initial={{ opacity: 0, y: -100 }}
                                    animate={{ opacity: 1, y: 0 }}
                                >
